...
Three interactive charts (Plotly) on U.S. electricity affordability and demand. The
...
| State demand vs. real price change, 2019–2025 | `/scatter/` | 600 |
...
prices, deflated by CPI-U), U.S. Census Bureau American Community Survey PUMS (energy
burden), and Grid Strategies (load-growth forecasts).
